...
export default function Login() {
  ...
  const handleSettingsClick = () => {
    if (username === 'admin' && password === 'EPI@1epi') {
      setShowSettings(true);
    } else {
      toast.error('Invalid credentials for settings access');
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-4">
            <button
              type="submit"
              disabled={isLoading}
              className="cohenix-button flex-1 justify-center py-3"
            >
              {isLoading ? (
            ...
            <button
              ...
              className="cohenix-button bg-gray-500 hover:bg-gray-600 focus:ring-gray-500"
            >
            ...
            <div className="cohenix-card w-full max-w-md p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={newSettings.baseUrl}
                    onChange={(e) => setNewSettings({ ...newSettings, baseUrl: e.target.value })}
                    className="cohenix-input mt-1"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewSettings({ ...newSettings, apiKey: e.target.value })}
                    className="cohenix-input mt-1"
                ...
                <div>
                  ...
                  <input
                    type="password"
                    value={newSettings.apiSecret}
                    onChange={(e) => setNewSettings({ ...newSettings, apiSecret: e.target.value })}
                    className="cohenix-input mt-1"
                ...
                <div className="flex space-x-4 pt-4">
                  <button
                    ...
                    className="cohenix-button flex-1 justify-center bg-gray-500 hover:bg-gray-600 focus:ring-gray-500"
                  >
                    {isTestingConnection ? (
                      <Loader2 className="h-5 w-5 animate-spin" />
                    ) : (
                      <>
                        ...
                        {connectionStatus === 'error' && (
                          <X className="h-5 w-5 ml-2 text-red-400" />
                        )}
                      </>
                    )}
                  </button>
                  ...
                  <button
                    ...
                    className="cohenix-button flex-1 justify-center"
                  >
                    Save Settings
                  </button>
                </div>
